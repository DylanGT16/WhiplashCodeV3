...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(4.1, 0.0, 0.0);        // Fwd/rev constants, used for odom and non odom motions
  ...
  chassis.pid_odom_angular_constants_set(1, 0.0, 0);    // Angular control for odom motions
