...
void Right() {
  ...
  MatchLoader.set(true);
  Lever.move_absolute(0,127);
  chassis.pid_drive_set(29.9_in,127);
  pros::delay(1900);
  ...
  pros::delay(550);
  chassis.pid_drive_set(13.8_in,127);
  pros::delay(800);
...
void Left() {
  ...
  chassis.pid_turn_set(-90,110);
  pros::delay(500);
  chassis.pid_drive_set(13.5,127);
  pros::delay(1550);
  ...
  Lever.move(127);
  Channel.move(60);
  chassis.pid_drive_set(16.7_in,127);
  pros::delay(850);
  chassis.pid_turn_set(135,110);
  pros::delay(550);
  MatchLoader.set(false);
  ...
  Lever.move_absolute(650,127);
  pros::delay(1500);
  chassis.pid_drive_set(35.2_in,127);
  pros::delay(900);
  Channel.move(0);
  Lever.move_absolute(0,127);
  chassis.pid_turn_set(-90,110);
...
void StatesSkills() {
  ScoreSwitcher.set(true);
  Channel.move(127);
  chassis.pid_drive_set(32.8_in,127);
  pros::delay(900);
  MatchLoader.set(true);
  chassis.pid_turn_set(90,110);
  pros::delay(500);
  chassis.pid_drive_set(12.7,80);
  pros::delay(2500);
  ...
  chassis.pid_turn_set(-135,110);
  pros::delay(500);
  chassis.pid_drive_set(17.3,127);
  pros::delay(800);
  chassis.pid_turn_set(-90,110);
  pros::delay(500);
