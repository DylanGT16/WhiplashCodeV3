...
void Right() {
  ...
  pros::delay(1700);
  Scorer.move(0);
  chassis.pid_drive_set(33_in,90);
  pros::delay(1900);
  ...
  pros::delay(500);
  chassis.pid_turn_set(-79,110);
  pros::delay(500);
  chassis.pid_drive_set(8_in,127);
  pros::delay(500);
  chassis.pid_turn_set(-28,110);
  pros::delay(500);
...
void Skills(){
  ...
  pros::delay(900);
  chassis.pid_drive_set(3.5_in,127);
  pros::delay(900);
  chassis.pid_drive_set(-3_in,127);
  pros::delay(900);
  chassis.pid_drive_set(3.5_in,127);
  ...
  chassis.pid_drive_set(-70_in,127);
  pros::delay(2000);
  chassis.pid_turn_set(33,110);
  pros::delay(500);
  chassis.pid_drive_set(-20_in,127);
  pros::delay(1000);
  chassis.pid_turn_set(-90,110);
