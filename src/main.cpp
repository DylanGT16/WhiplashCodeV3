...
ez::tracking_wheel horiz_tracker(2, 2, 3);  // This tracking wheel is perpendicular to the drive wheels
ez::tracking_wheel vert_tracker(3, 2, 1.5);   // This tracking wheel is parallel to the drive wheels
